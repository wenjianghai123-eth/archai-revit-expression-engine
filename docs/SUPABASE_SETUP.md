...
- `prompt_templates`: `id`, `name`, `description`, `generation_step`, `feature_name`, `prompt`, `negative_prompt`, `config`, `input_asset_ids`, `reference_asset_ids`, `material_asset_ids`, `source_asset_id`, `placement_preview_asset_id`, `output_asset_id`, `output_url`, `preview_asset_id`, `tags`, `is_public`, `created_from_generation_record_id`, `created_from_job_id`, `created_by`, `input_previews`, `output_preview`, `parameter_summary`, `template_source`, `cover_asset_id`, `cover_url`, `created_at`, `updated_at`
