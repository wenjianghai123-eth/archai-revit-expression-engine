...
export const DEFAULT_CONFIGS: Record<GenerationStep, GenerationConfig> = {
  ...
  [GenerationStep.DesignVariants]: {
    ...
    variantLocks: ['structure', 'space-layout', 'fixed-hard-decoration', 'camera'],
    variantMatrixVariables: ['material-system', 'color-system', 'lighting-atmosphere', 'soft-decoration-richness', 'decoration-details'],
  ...
  [GenerationStep.ObjectInsert]: {
    ...
    objectInsertSceneEnrichment: { plants: 'moderate', people: 'few', decorations: 'moderate' },
  ...
  [GenerationStep.FreeReferenceImage]: {
    ...
    freeReferenceAspectRatio: 'source',
    freeReferenceStructureControl: 'balanced',
    freeReferenceCandidateCount: 1,
    freeReferenceWorkflowMode: 'custom',
  ...
  [GenerationStep.ImagePolish]: {
    ...
    imagePolishControls: { ...DEFAULT_IMAGE_POLISH_CONTROLS.conservative },
    addPeople: false,
    peopleLevel: 'none',
    addPlants: false,
    plantLevel: 'none',
