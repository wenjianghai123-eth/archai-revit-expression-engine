...
describe('floor plan material prompt compiler', () => {
  it('states image roles, geometry locks and region material schedule', () => {
    const prompt = compileFloorPlanMaterialPrompt({
      ...
      assignments: [{ regionId: 'region-1', number: 1, roomName: 'Kitchen', materialName: 'grey anti-slip tile', materialAssetId: 'material', fallbackMode: 'reference', scale: 1, rotation: 0, direction: 'horizontal', jointMode: 'subtle' }],
    });
